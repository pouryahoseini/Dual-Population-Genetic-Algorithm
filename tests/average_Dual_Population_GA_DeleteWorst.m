function [ average_fitness, average_time, average_evaluations, std_fitness, std_time, std_evaluations ] = average_Dual_Population_GA_DeleteWorst( reruns_number, test_function, population_size, chromosome_size, iteration_number, tournament_size, crossover_rate, mutation_rate, selection_type, crossover_type, termination_condition, max_evaluations )
%The function to take average of the steady-state genetic algorithm with the
%delete-the-worst dual-population scheme enabled
...
%running Delete-the-Worst Dual-Population GA
...
for count=1:reruns_number
    [fitness(count), proc_time(count), eval_number(count)] = Dual_Population_GA_DeleteWorst( test_function, population_size, chromosome_size, iteration_number, tournament_size, crossover_rate, mutation_rate, selection_type, crossover_type, termination_condition, max_evaluations );
...
if Printing_Enabled==true
    fprintf('Delete-the-Worst Dual-Population GA''s average fitness is %d over %d runs. Average processing time is %d. Average number of evaluations is %d\n', average_fitness, reruns_number, average_time, average_evaluations);
end
