function [ average_fitness, average_time, average_evaluations, std_fitness, std_time, std_evaluations ] = average_Compact_GA( reruns_number, test_function, population_size, chromosome_size, termination_condition, max_evaluations  )
%This function takes average of Compact Genetic Algorithm
...
for count=1:reruns_number
    [fitness(count), proc_time(count), eval_number(count)] = Compact_GA( test_function, population_size, chromosome_size, termination_condition, max_evaluations );
...
if Printing_Enabled==true
    fprintf('Compact GA''s average fitness is %d over %d runs. Average processing time is %d. Average number of evaluations is %d\n', average_fitness, reruns_number, average_time, average_evaluations);
end
