function [ average_fitness, average_time, average_evaluations, std_fitness, std_time, std_evaluations ] = average_OIMGA( reruns_number, test_function, population_size, chromosome_size, search_size, t_gens, k_gens, d_adjustor, mutation_rate, termination_condition, max_evaluations )
%This function takes average of OIMGA Genetic Algorithm
...
for count=1:reruns_number
    [fitness(count), proc_time(count), eval_number(count)] = OIMGA( test_function, population_size, chromosome_size, search_size, t_gens, k_gens, d_adjustor, mutation_rate, termination_condition, max_evaluations );
...
if Printing_Enabled==true
    fprintf('OIMGA GA''s average fitness is %d over %d runs. Average processing time is %d. Average number of evaluations is %d\n', average_fitness, reruns_number, average_time, average_evaluations);
end
